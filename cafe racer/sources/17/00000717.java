...
public class CustomPropertyKey extends AbstractSafeParcelable {
    ...
    public CustomPropertyKey(String str, int i) {
        Preconditions.checkNotNull(str, KeyValDatabase.KEYVAL_COLUMN_KEY);
    ...
    public JSONObject toJson() throws JSONException {
        ...
        jSONObject.put(KeyValDatabase.KEYVAL_COLUMN_KEY, getKey());
    ...
    public static CustomPropertyKey fromJson(JSONObject jSONObject) throws JSONException {
        return new CustomPropertyKey(jSONObject.getString(KeyValDatabase.KEYVAL_COLUMN_KEY), jSONObject.getInt("visibility"));
    }
}
...
final class zzat extends com.google.android.gms.internal.games.zzar<String> {
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzat(PlayersClient playersClient) {
    }
    ...
    protected final void zza(com.google.android.gms.games.internal.zzg zzgVar, TaskCompletionSource<String> taskCompletionSource) throws RemoteException {
        taskCompletionSource.setResult(zzgVar.zza(true));
    }
}
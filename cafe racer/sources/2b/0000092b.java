...
final class zzav extends com.google.android.gms.internal.games.zzar<Intent> {
    private final /* synthetic */ Player zzdg;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzav(PlayersClient playersClient, Player player) {
        this.zzdg = player;
    }
    ...
    protected final void zza(com.google.android.gms.games.internal.zzg zzgVar, TaskCompletionSource<Intent> taskCompletionSource) throws RemoteException {
        taskCompletionSource.setResult(zzgVar.zza(new PlayerEntity(this.zzdg)));
    }
}
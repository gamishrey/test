...
public class MetricCommonTags {
    ...
    private final IObserver<PrivacyConfig> _privacyObserver = new IObserver<PrivacyConfig>() { // from class: com.unity3d.services.core.request.metrics.MetricCommonTags.1
    ...
    private String _privacyMode = PrivacyConfigStorage.getInstance().getPrivacyConfig().getPrivacyStatus().toLowerCase();

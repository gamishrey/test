...
public final class zzcq extends com.google.android.gms.internal.games.zzar<Intent> {
    private final /* synthetic */ int zzdq;
    private final /* synthetic */ int zzdr;
    private final /* synthetic */ boolean zzds;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzcq(TurnBasedMultiplayerClient turnBasedMultiplayerClient, int i, int i2, boolean z) {
        this.zzdq = i;
        this.zzdr = i2;
        this.zzds = z;
    }
    ...
    protected final void zza(com.google.android.gms.games.internal.zzg zzgVar, TaskCompletionSource<Intent> taskCompletionSource) throws RemoteException {
        taskCompletionSource.setResult(zzgVar.zza(this.zzdq, this.zzdr, this.zzds));
    }
}
...
public final class zzbe extends zzbm {
    ...
    public zzbe(zzba zzbaVar, GoogleApiClient googleApiClient, String str, int i, int i2, int i3, boolean z) {
    ...
    protected final /* synthetic */ void doExecute(com.google.android.gms.games.internal.zzg zzgVar) throws RemoteException {
        zzgVar.zza(this, this.zzbo, this.zzkh, this.zzki, this.zzkj, this.zzkb);
    }
}
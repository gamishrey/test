...
final class zzbx extends zzcc {
    ...
    public zzbx(zzbu zzbuVar, GoogleApiClient googleApiClient, int i, boolean z) {
    ...
    protected final /* synthetic */ void doExecute(com.google.android.gms.games.internal.zzg zzgVar) throws RemoteException {
        zzgVar.zza((BaseImplementation.ResultHolder<Players.LoadPlayersResult>) this, "played_with", this.zzkn, false, this.zzkb);
    }
}
    ...
    private final zzl zza(String str, int i) {
        try {
            ...
            if (zza.signatures != null && zza.signatures.length == 1) {
                ...
                return (!zza2.zzap || zza.applicationInfo == null || (zza.applicationInfo.flags & 2) == 0 || !zzc.zza(str2, zzgVar, false, true).zzap) ? zza2 : zzl.zzb("debuggable release cert app rejected");
            }
    ...
    private final zzl zzc(String str) {
        ...
        try {
            ...
            if (packageInfo == null) {
                ...
                zzb = (!zza.zzap || packageInfo.applicationInfo == null || (packageInfo.applicationInfo.flags & 2) == 0 || !zzc.zza(str2, zzgVar, false, true).zzap) ? zza : zzl.zzb("debuggable release cert app rejected");
            }
            if (zzb.zzap) {
                this.zzau = str;
            }

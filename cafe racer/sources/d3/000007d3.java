...
public class RealTimeMultiplayerClient extends com.google.android.gms.internal.games.zzad {
    ...
    public Task<Void> create(RoomConfig roomConfig) {
        ListenerHolder<L> registerListener = registerListener(roomConfig.zzdp(), com.google.android.gms.games.multiplayer.realtime.zzg.class.getSimpleName());

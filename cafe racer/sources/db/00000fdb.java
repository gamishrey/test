...
public class GMAScarAdapterBridge {
    ...
    private final InitializeListenerBridge _initializationListenerBridge = new InitializeListenerBridge();
    private final AdapterStatusBridge _adapterStatusBridge = new AdapterStatusBridge();
    ...
    private final PresenceDetector _presenceDetector = new PresenceDetector(this._mobileAdsBridge, this._initializationListenerBridge, this._initializationStatusBridge, this._adapterStatusBridge);
